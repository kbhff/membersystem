...
<div id="menu">
  <ul>
   ...
   <li>
    <a href="#">Min kontaktinfo</a> 
   </li>   
  </ul>
 </div>

<h1>Frugtcentret Roskilde</h1>
<h2></h2>
<?php echo $content;?>

<h2>KBHFF &oslash;nsker tilbud p&aring;</h2>
...
Sp&oslash;rgsm&aring;l rettes til: <a href="mailto:indkob@kbhff.dk">indkob@kbhff.dk</a><br>
<br>
<h2>Opret tilbud til KBHFF</h2>
<form action="/leverandor/tilbud/" method="post">
<table>
...
<tr><td valign="top">Pris:</td><td valign="top"><input type="text" name="pris" size="40" maxlength="40"><br><span class="note">Evt. m&aelig;ngderabat?</span></td></tr>
<tr><td>Max. m&aelig;ngde:</td><td><input type="text" name="max" size="40" maxlength="40"></td></tr>
<tr><td>Evt. min. m&aelig;ngde:</td><td><input type="text" name="min" size="40" maxlength="40"></td></tr>
<tr><td valign="top">Pakket:</td><td valign="top"><input type="text" name="pakket" size="40" maxlength="40"><br><span class="note">Hvordan er varen pakket?</span></td></tr>
<tr><td>Levering:</td><td><input type="text" name="dato" id="dato" size="20" maxlength="20"> 
<tr><td>Bestilles inden:</td><td><input type="text" name="dato2" id="dato2" size="10" maxlength="10">
</table>
<input type="submit" value="Send tilbud" class="form_button"><br>
</form>
