...
<script type="text/javascript" src="/ressources/md5.js"></script>
...
$("#pwbox").focus(function(){
              $(this).addClass("activeField").removeClass("idle");
				...
				document.forms['login']['phash'].value = MD5(MD5(document.forms['login']['pw'].value) + document.forms['login']['hts'].value); 
