...
<br clear="all">	
	<form action="<?php echo site_url(); ?>blivmedlem/index/<?php echo $admin; ?>" method="post" class="fc_form"> 
		...
		<fieldset>
		<legend>Registrering af indmelding af eksisterende medlem</legend>
		<div id="message">
		...
		<?php if (isset ($errors)) echo $errors; ?>
			...
			<ol>
				...
				<li>
					<input type="submit" value="Opret, medlemmet har allerede betalt" class="form_button" />
				</li>
			</ol>
		<br />
		<div id="form_remarks">
