...
<br>
<form action="/kassemester/ordreliste" method="post">
Hent ordreliste i Excel-format: <select name="divisionday">
<?= $sel ?>
</select> <input type="submit" value="Hent Excel" class="form_button"></form>
<br>
<?= $medlemordreliste ?>
<br>
